...
if mode=='draft':
    ...
    movie=ROOT/'HuangHuaYu_Growing_Rose_3072x4096_4K.mp4'
    ...
    subprocess.run([ffmpeg,'-y','-loglevel','warning','-i',str(movie),'-an','-vf','scale=1080:1440:flags=lanczos','-c:v','libx264','-preset','slow','-crf','18','-pix_fmt','yuv420p','-refs','1','-bf','0','-g','30','-movflags','+faststart',str(ROOT/'HuangHuaYu_Growing_Rose_Preview_1080.mp4')],check=True)
